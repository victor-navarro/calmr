...
where $M_{i \leftarrow j}'$ and $M_{i}'$ are the quantities before $j$ was observed, $k$ and $\alpha$ are learning rate parameters, and $E_{i \leftarrow j}$ is the elegibility trace of stimulus $i$ at the time $j$ occurs (see Eq. 1).

...
des_df <- data.frame(group = c("CB1", "CB2"),
                     ...
                     rand_train = T)
#The parameters
pars <- get_params(des_df, model = "HD2022") #the actual parameter values don't matter, as our function will re-write them inside the optimizer call
#The options
opts <- get_model_opts(iterations = 4)
#The arguments

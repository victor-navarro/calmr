...
If you ever want to check if your trials string will work with the simulator, you can use `trial_parser`. The function returns a list with trial_names (the name of the trial), trial_repeats (the number of times each trial is given), trial_stimuli (a list with the elements on each trial), is_test (a list specifying whether the trial does not result in learning), and a vector of stimuli (the stimuli found in the trial string).

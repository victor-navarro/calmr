...
And we can finally simulate the model with `run_heidi`. By default, the function returns a list with aggregated data. Let's see.
...
But, we rarely want the raw data. If you are like me, you will want to see some plots. Let's use `make_plots` to create some plots, and `patch_plots` to display them. Here they are, paired side by side.

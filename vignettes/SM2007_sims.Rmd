...
In this script, I attempt to use calmr's implementation of SOCR to reproduce some of the figures in @witnauer_performance_2012.
Note, this notebook requires a version of calmr with the SM2007 model implemented. At the time of this notebook, you can install such a version using `devtools::install_github("victor-navarro/calmr@socr-dev")`
...
m <- run_experiment(des, model = mod, param_df = pars) #takes a bit
#plot(m, "relacts")
#Fig 14
m@parsed_results$relacts %>%
filter(s2 == "US" & phase == "P3") %>%

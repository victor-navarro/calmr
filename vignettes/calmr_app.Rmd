...
you can find it at: [https://victor-navarro.shinyapps.io/calmr_app/](https://victor-navarro.shinyapps.io/calmr_app/). Alternatively, if you have installed the calm package, you can launch the app via `calm::calmr_app()`.
The rest of the tutorial assumes that you have the app open and ready to run. 
Let's break down the GUI.

# The GUI

![The calm app GUI upon launch](calmr_app_clean_app.png){width=600px}
...
![The calm app GUI after parsing](calmr_app_parsed_app.png){width=600px}
...
![The calm app GUI after running the model](calmr_app_ran_app.png){width=600px}

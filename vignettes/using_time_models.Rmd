...
Version 0.5 of `calm` introduced its first time-based model, ANCCR [@jeong_mesolimbic_2022], and with it, 
I wrote several additional tools for future models.

#### Changes to trial-based models

The biggest change in calm version 0.5 is the use of the ">" character and its effect on trial-based models. Before, the ">" character was used to specify a single split within a trial.
